...
<div style="position: relative;">
    <span style="color: black; font-size: xxx-large; font-weight:bold; text-align: center;">Hi ${doctor.userName}, Your Availability</span>
    <span style="float: right; font-size: large;"> <a href="/logout"> Logout </a> </span>
    <br/><br/>
    <span style="color: black; font-size: xx-large; font-weight:bold; text-align: center;">${currentDate}</span>
    <br/><br/>
